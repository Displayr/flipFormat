...
ria <- structure(list(raw.importance = c(0.118944441811052, 0.0739776637555959, 0.0877737045218754, 0.126469123604018, 0.0451172891545317, 0.0380904799320387),
               ...
               t.statistics = c(6.44932891481065, 4.94411257367377, 5.62059680923224, 5.90500920459211, 3.84187349272331, 3.54931547901809),
          ...
          .Names = c("raw.importance", "importance", "standard.errors", "df", "t.statistics", "p.values"))
